...
assert legacy < requested < effective < runtime_stage < os_available < schema, "manifest profile args are out of expected order"
...
assert legacy_field < requested_field < effective_field < runtime_stage_field < os_available_field < schema_field, "manifest profile fields are out of expected order"
